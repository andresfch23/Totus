...
import ProfileImage from '../assets/images/Jhoana.jpg'
  ...
  render() {
    return (
      <div className="grid">
          ...
          <div className="grid__item three-fifths about__biography">
              <div className="about__presentation">
                  <div className="about__profile">
                        <img className="about__profile-image" src={ProfileImage} alt="Profile"></img>
