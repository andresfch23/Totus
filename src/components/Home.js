            ...
            <div className="grid main">
              <div className="grid__item one-third">
                ...
                <div className="main__magazine">
                  <img className="main__image" src={MagazineImageLeft} alt="Virgin Mary" />
                </div>
              </div>
              ...
              <div className="grid__item one-third">
                <div className="main__magazine">
                  <img className="main__image" src={MagazineImageRight} alt="Crist on the cross" />
                </div>
                <div className="main__advertisement">
                  <h1 className="main__advertisement-text-down">
                    ¿Por que los catolicos decidimos incursionar en la
                    politica?
                  </h1>
                </div>
              </div>
